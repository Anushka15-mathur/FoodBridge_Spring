...
public class ProfileController {
    ...
    public ResponseEntity<String> completeRestaurantProfile(
        ...
        profileService.completeRestaurantProfile(request, logo, certificate);
    ...
    public ResponseEntity<String> completeNgoProfile(
            ...
            @RequestPart(value = "logo", required = false) MultipartFile logo,
            @RequestPart(value = "registrationCertificate", required = false)
                    MultipartFile registrationCertificate) {

        profileService.completeNgoProfile(request, logo, registrationCertificate);
    ...
    public ResponseEntity<String> completeVolunteerProfile(
            ...
            @RequestPart(value = "drivingLicense", required = false)
                    MultipartFile drivingLicense,
            @RequestPart(value = "identityProof", required = false)
                    MultipartFile identityProof) {

        profileService.completeVolunteerProfile(request, drivingLicense, identityProof);
    ...
    public ResponseEntity<String> completeDonorProfile(
            ...
            @RequestPart(value = "organizationProof", required = false)
